...
const WARRANTY_HTML = '<div style="margin-top:20px;flex-grow:1;display:flex;align-items:center;"><img src="https://i.imgur.com/Jg9yNW9.png" alt="" loading="lazy" decoding="async" style="height:16px;"><span style="margin-left:10px;font-family:proximanovaregular;font-weight:400;font-size:14px;color:rgba(0,0,0,.55);">12 meses de garantia de fábrica.</span></div>';
